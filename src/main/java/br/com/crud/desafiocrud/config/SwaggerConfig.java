package br.com.crud.desafiocrud.config;
...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
                ...
                .apis(RequestHandlerSelectors.basePackage("br.com.crud.desafiocrud.controllers"))
                .paths(PathSelectors.any()).build().apiInfo(apiInfo());
    }

    private ApiInfo apiInfo() {
        return new ApiInfo("Desafio CRUD",
                "Esta API é referente ao Desafio CRUD", "Versão 1.0", null,
                new Contact("Trainee Java", "https://github.com/jonathac/DesafioCrud", "email@email.com.br"),
